...
class ogbSectionEdit extends Component {
				...
				<InspectorControls>
					<PanelBody title={ __( 'General' ) } initialOpen={ true }>
						...
						<SelectControl
							...
							className={ 'ogb-html-tag' }
							value={ htmlTag }
							onChange={ ( value ) => setAttributes( { htmlTag: value } ) }
							options={ [
								{ value: "section", label: __("Section", 'ocean-gutenberg-blocks') },
								{ value: "div", label: __("Div", 'ocean-gutenberg-blocks') },
								{ value: "aside", label: __("Aside", 'ocean-gutenberg-blocks') },
								{ value: "header", label: __("Header", 'ocean-gutenberg-blocks') },
								{ value: "footer", label: __("Footer", 'ocean-gutenberg-blocks') },
								{ value: "main", label: __("Main", 'ocean-gutenberg-blocks') },
								{ value: "article", label: __("Article", 'ocean-gutenberg-blocks') },
								{ value: "nav", label: __("Nav", 'ocean-gutenberg-blocks') }
							] }
						/>
