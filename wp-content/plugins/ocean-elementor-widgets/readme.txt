...
= 2.4.5 - NOV 13 2024 =
- NEW: Widget: Story Portfolio.
- NEW: Widget: Table of Contents.
- Added: Controls: Accordion: Icon size.
- Added: Controls: Alert: Icon, Icon size, Icon spacing, Icon color.
- Added: Controls: Banner: Title text shadow, Description text shadow.
- Added: Controls: Blog Grid: Avatar Border radius, Title text shadow.
- Added: Controls: Info Box: Icon.
- Added: Controls: Link Effects: Text shadow.
- Added: Controls: Logo: Border radius.
- Added: Controls: Price Table: Button icon + related icon controls.
- Added: Controls: New Pricing Table: Button icon + related icon controls.
- Updated: WordPress version number for compatibility.
- Fixed: Woo Slider: Removing product from cart makes the slider stop functioning, if the widget is used on the Woo cart page.
- Fixed: Elementor: Duplicate loading of swiper.min.js
- Fixed: Compatibility: Elementor: Editor TopBar.
