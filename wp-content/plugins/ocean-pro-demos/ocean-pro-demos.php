 ...
 * Description:			A premium plugin with powerful and complete options for web designers: import OceanWP Full website templates with all pages and styling; Elementor Sections Library templates; import images and icons from Freepik; build Popups; create Custom Post Types; add Google tag, Facebook pixel and other tracking options.
 * Version:				1.5.2
...
final class Ocean_Pro_Demos {
	...
	public function init() {
		...
		require_once OPD_PATH . 'modules/pixel-tracker/pixel-tracker.php';
		require_once OPD_PATH . '/includes/themepanel/theme-panel.php';

		if ( ! is_plugin_active( 'ocean-ecommerce/ocean-ecommerce.php' ) ) {
			$opd_popup_builder_enable = get_option( 'opd_popup_builder_enable', 'no' );
			if ( 'yes' === $opd_popup_builder_enable ) {
				require_once OPD_PATH . 'modules/popup-builder/popup-builder.php';
			}
		}

		$opd_cpt_manager_enable = get_option( 'opd_cpt_manager_enable', 'no' );
			if ( 'yes' === $opd_cpt_manager_enable ) {
				require_once OPD_PATH . 'modules/cpt-manager/ocean-cpt.php';
		}
	...
	public static function get_pro_demos( $data ) {
		...
		$data['elementor'] = array(
			...
			'camera' => array(
				'categories'  		=> array( 'eCommerce' ),
				'xml_file'     		=> $url . 'camera/sample-data.xml',
				'theme_settings' 	=> $url . 'camera/oceanwp-export.dat',
				'form_file'  		=> $url . 'camera/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '6',
				'elementor_width'  	=> '1340',
				'is_shop'  			=> true,
				'woo_image_size'  	=> '600',
				'woo_thumb_size' 	=> '300',
				'woo_crop_width'  	=> '1',
			...
			'cowork' => array(
				'categories'        => array( 'Business' ),
				'xml_file'     		=> $url . 'cowork/sample-data.xml',
				'theme_settings' 	=> $url . 'cowork/oceanwp-export.dat',
				'form_file'  		=> $url . 'cowork/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'News',
				'posts_to_show'  	=> '6',
				'elementor_width'  	=> '1300',
				'required_plugins'  => array(
					'free' => array(
						array(
							'slug'  	=> 'ocean-extra',
			...
			'itech' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'itech/sample-data.xml',
				'theme_settings' 	=> $url . 'itech/oceanwp-export.dat',
				'form_file'  		=> $url . 'itech/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '6',
			...
			'mechanic' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'mechanic/sample-data.xml',
				'theme_settings' 	=> $url . 'mechanic/oceanwp-export.dat',
				'form_file'  		=> $url . 'mechanic/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '6',
			...
			'arquitecte' => array(
				'categories'        => array( 'Business' ),
				'xml_file'     		=> $url . 'arquitecte/sample-data.xml',
				'theme_settings' 	=> $url . 'arquitecte/oceanwp-export.dat',
				'form_file'  		=> $url . 'arquitecte/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '4',
				'elementor_width'  	=> '1300',
			...
			'creatads' => array(
				'categories'        => array( 'Business' ),
				'xml_file'     		=> $url . 'creatads/sample-data.xml',
				'theme_settings' 	=> $url . 'creatads/oceanwp-export.dat',
				'form_file'  		=> $url . 'creatads/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'snorkel' => array(
				'categories'        => array( 'Business', 'Sport', 'Blog' ),
				'xml_file'     		=> $url . 'snorkel/sample-data.xml',
				'theme_settings' 	=> $url . 'snorkel/oceanwp-export.dat',
				'form_file'  		=> $url . 'snorkel/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'golfgame' => array(
				...
				'xml_file'     		=> $url . 'golfgame/sample-data.xml',
				'theme_settings' 	=> $url . 'golfgame/oceanwp-export.dat',
				'form_file'  		=> $url . 'golfgame/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'camstack' => array(
				'categories'        => array( 'eCommerce' ),
				'xml_file'     		=> $url . 'camstack/sample-data.xml',
				'theme_settings' 	=> $url . 'camstack/oceanwp-export.dat',
				'form_file'  		=> $url . 'camstack/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'app' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'app/sample-data.xml',
				'theme_settings' 	=> $url . 'app/oceanwp-export.dat',
				'form_file'  		=> $url . 'app/form.json',
				'home_title'  		=> 'Home',
				'elementor_width'  	=> '1200',
				'required_plugins'  => array(
					'free' => array(
			...
			'webdev' => array(
				...
				'xml_file'     		=> $url . 'webdev/sample-data.xml',
				'theme_settings' 	=> $url . 'webdev/oceanwp-export.dat',
				'form_file'  		=> $url . 'webdev/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '4',
				'elementor_width'  	=> '1200',
			...
			'kiddystar' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'kiddystar/sample-data.xml',
				'theme_settings' 	=> $url . 'kiddystar/oceanwp-export.dat',
				'form_file'  		=> $url . 'kiddystar/form.json',
				'home_title'  		=> 'Home',
				'elementor_width'  	=> '1200',
				'required_plugins'  => array(
					'free' => array(
			...
			'dreamhome' => array(
				'categories'        => array( 'eCommerce' ),
				'xml_file'     		=> $url . 'dreamhome/sample-data.xml',
				'theme_settings' 	=> $url . 'dreamhome/oceanwp-export.dat',
				'form_file'  		=> $url . 'dreamhome/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'mentor' => array(
				'categories'        => array( 'Business', 'Blog', 'One Page' ),
				'xml_file'     		=> $url . 'mentor/sample-data.xml',
				'theme_settings' 	=> $url . 'mentor/oceanwp-export.dat',
				'form_file'  		=> $url . 'mentor/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'thrive' => array(
				'categories'        => array( 'Business', 'Blog', 'One Page' ),
				'xml_file'     		=> $url . 'thrive/sample-data.xml',
				'theme_settings' 	=> $url . 'thrive/oceanwp-export.dat',
				'form_file'  		=> $url . 'thrive/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '10',
				'elementor_width'  	=> '1200',
			...
			'carwash' => array(
				'categories'        => array( 'Business' ),
				'xml_file'     		=> $url . 'carwash/sample-data.xml',
				'theme_settings' 	=> $url . 'carwash/oceanwp-export.dat',
				'form_file'  		=> $url . 'carwash/form.json',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '3',
				'elementor_width'  	=> '1200',
			...
			'rocksolid' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'rocksolid/sample-data.xml',
				'theme_settings' 	=> $url . 'rocksolid/oceanwp-export.dat',
				'home_title'  		=> 'Home',
				'blog_title'  		=> 'Blog',
				'posts_to_show'  	=> '3',
				'elementor_width'  	=> '1200',
			...
			'innovations' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'innovations/sample-data.xml',
				'theme_settings' 	=> $url . 'innovations/oceanwp-export.dat',
				'form_file'  		=> $url . 'innovations/form.json',
				'home_title'  		=> 'Home',
				'elementor_width'  	=> '1200',
				'required_plugins'  => array(
					'free' => array(
			...
			'coursela' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'coursela/sample-data.xml',
				'theme_settings' 	=> $url . 'coursela/oceanwp-export.dat',
				'form_file'  		=> $url . 'coursela/form.json',
				'home_title'  		=> 'Home',
				'elementor_width'  	=> '1200',
				'required_plugins'  => array(
					'free' => array(
			...
			'plumbing' => array(
				'categories'        => array( 'Business', 'One Page' ),
				'xml_file'     		=> $url . 'plumbing/sample-data.xml',
				'theme_settings' 	=> $url . 'plumbing/oceanwp-export.dat',
				'form_file'  		=> $url . 'plumbing/form.json',
				'home_title'  		=> 'Home',
				'elementor_width'  	=> '1200',
				'required_plugins'  => array(
					'free' => array(
