...
var utils = (function () {
    ...
    me.addEvent = function (el, type, fn, capture) {
        ...
        const isWheel = type === 'wheel' || type === 'mousewheel';
        const options = isTouch ? { passive: true, capture: !!capture } : isWheel ? { passive: true } : !!capture;
...
(function (window, document) {
    window.fp_scrolloverflow = (function() {
        ...
        */
        ...
        //     this.wrapper.addEventListener("wheel", this, options);
        //     this.wrapper.addEventListener("mousewheel", this, options);
        //     this.wrapper.addEventListener("DOMMouseScroll", this, options);
        ...
        */
        ...
        IScroll.prototype.wheelOn = function () {
            this.updateWheelEvents('addEventListener');
        };

        IScroll.prototype.wheelOff = function () {
            this.updateWheelEvents('removeEventListener');
        };

        IScroll.prototype.updateWheelEvents = function (method) {
            const eventListenerOptions = { passive: true };

            const updateEventListeners = (event) => {
                if (event.target === this.wrapper) {
                    event.preventDefault();
                }
            };

            this.wrapper[method]('wheel', updateEventListeners, eventListenerOptions);
            this.wrapper[method]('mousewheel', updateEventListeners, eventListenerOptions);
            this.wrapper[method]('DOMMouseScroll', updateEventListeners, eventListenerOptions);
        };
