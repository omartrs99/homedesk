...
= 1.5.2 - NOV 13 2024
- Added: Google Consent: Visual customizer.
- Added: Popup Builder: Entrance animations.
- Added: Elementor Library: Popup templates.
- Added: CPT: Custom design options.
- Updated: WordPress version number for compatibility.
- Fixed: CPT: Translation: correct text domain.
- Fixed: Popup Builder: Console JS error in Elementor editor.
- Fixed: Popup Builder: Popups display in the Widgets area (Appearance > Widgets).
