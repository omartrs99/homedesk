...
function op_portfolio_cac_has_filter_type_default() {
	if ( 'on' == get_theme_mod( 'op_portfolio_filter', 'off' )
		&& 'default' == get_theme_mod( 'op_portfolio_filter_type', 'default' ) ) {
		return true;
	} else {
		return false;
	}
...
function op_portfolio_cac_has_filter_type_button() {
	if ( 'on' == get_theme_mod( 'op_portfolio_filter', 'off' )
		&& 'button' == get_theme_mod( 'op_portfolio_filter_type', 'default' ) ) {
		return true;
	} else {
		return false;
	}
...
function op_portfolio_cac_has_img_animation() {
	if ( true == get_theme_mod( 'op_portfolio_img_animation', false ) ) {
		return true;
	} else {
		return false;
	}
